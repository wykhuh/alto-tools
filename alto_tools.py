...
def parse_arguments():
    ...
    parser.add_argument("INPUT", nargs="+", help="path to ALTO file")
    parser.add_argument(
        "-o",
        "--output",
        default="",
    ...
    parser.add_argument(
        "-E", "--xml-encoding", dest="xml_encoding", default=None, help="XML encoding"
    )
    parser.add_argument(
        "--file-encoding", dest="file_encoding", default="UTF-8", help="File encoding"
    )
